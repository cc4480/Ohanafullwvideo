  ...
  private initializeData() {
    ...
    this.properties = [
      ...
      },
      {
        ...
        bathrooms: '2.0',
        squareFeet: 1450,
        description: 'Stunning 3-bedroom, 2-bathroom home in a prime Laredo location with contemporary design.',
        ...
        createdAt: new Date(),
        updatedAt: new Date(),
        seoMetaTitle: '3BR House for Sale - 3405 Juan Novoa Dr, Laredo TX',
        seoMetaDescription: 'Modern 3-bedroom home with granite countertops and energy efficient features',

...
>(({ className, children, ...props }, ref) => {
  ...
  const needsFallbackDescription = !hasAriaDescribedby && !hasDescriptionInChildren;
  ...
  return (
    <DialogPortal>
      ...
      <DialogPrimitive.Content
        ref={ref}
        aria-describedby={hasAriaDescribedby ? props['aria-describedby'] : needsFallbackDescription ? descriptionId : undefined}
        className={cn(
